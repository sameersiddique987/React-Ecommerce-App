...
useEffect(() =>{
  ...
  return (
    <>
      ...
      <div className="px-4 sm:px-6 lg:px-10 flex flex-wrap justify-center gap-3">

  {
  
data ? <SingleCard  src={data.image} category={data.category} description={data.description}  /> :
